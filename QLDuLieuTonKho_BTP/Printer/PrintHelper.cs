...
namespace QLDuLieuTonKho_BTP.Printer
{
    public class PrintHelper
    {
        ...
        //        new TextLineSpec { Prefix = "Ngay SX: " + Helper.TaoKhoangTrong(25,printer.NgaySX) + " Ca SX:", Content = printer.NgaySX + new string(' ',12)  + printer.CaSX, X = 170 },
        ...
        //        new TextLineSpec { Prefix = "CN van hanh: " + Helper.TaoKhoangTrong(15,printer.TenCN) + " T.truong:", Content = printer.TenCN, X = 250 },
        //    }; 
